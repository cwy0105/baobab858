...
public class NonKaraokeVO {
	...
	public NonKaraokeVO(int seq_num, int num, String cp_name, String road_addr, String local_addr, String tel,
			String info, String kind, int rev_num, int hits, int rev_grade, double longitude, double latitude,
			double distance) {
		super();
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		NonKaraokeVO other = (NonKaraokeVO) obj;
		if (cp_name == null) {
	...
	public String toString() {
		return "NonKaraokeVO [seq_num=" + seq_num + ", num=" + num + ", cp_name=" + cp_name + ", road_addr=" + road_addr
				+ ", local_addr=" + local_addr + ", tel=" + tel + ", info=" + info + ", kind=" + kind + ", rev_num="
				+ rev_num + ", hits=" + hits + ", rev_grade=" + rev_grade + ", longitude=" + longitude + ", latitude="
