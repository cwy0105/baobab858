...
public class NonPCroomVO {
	...
	public NonPCroomVO(int seq_num, int num, String cp_name, String road_addr, String local_addr, String tel,
			String info, String kind, int hits, int rev_num, int rev_grade, double longitude, double latitude,
			double distance) {
		super();
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		NonPCroomVO other = (NonPCroomVO) obj;
		if (cp_name == null) {
	...
	public String toString() {
		return "NonPCroomVO [seq_num=" + seq_num + ", num=" + num + ", cp_name=" + cp_name + ", road_addr=" + road_addr
				+ ", local_addr=" + local_addr + ", tel=" + tel + ", info=" + info + ", kind=" + kind + ", hits=" + hits
				+ ", rev_num=" + rev_num + ", rev_grade=" + rev_grade + ", longitude=" + longitude + ", latitude="
